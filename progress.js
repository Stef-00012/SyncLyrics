...
if (!hexRegex.test(color1) || !hexRegex.test(color2)) {
    console.log("\x1b[31mThe colors must be hexadecimal (eg. #123 or #abcdef, including the #)")

    process.exit(0)
}

if (moduleName.startsWith('#custom-')) {
    console.log("\x1b[31mDo not include #custom- , only the module name (eg. if your module is custom/song, here you'll put song)")
